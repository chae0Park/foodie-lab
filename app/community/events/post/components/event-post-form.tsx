...
import classes from './event-post-form.module.css';
          ...
          <form className={classes.form} onSubmit={handleSubmit}>
            <ImagePicker label='Your image' name='image' />
              ...
              <label htmlFor="Detail">Detail</label>
                <p>
                  <input type='text' name='time' required placeholder='Event Start Time' />
                </p>
                <p>
                  <input type='text' name='estimatedTime' required placeholder='Event Duration Time' />
                </p>
                <p>
                  <input type="text" name="address" required placeholder='Event Venue Address'/>
                </p>
                <p>
                  <input type="text" name="fee" required placeholder='Event Fee'/>
                </p>
              </div>
              <p>
